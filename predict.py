...
model.load_state_dict(torch.load("tooth_classifier.pth"))  # مدل را بارگذاری می‌کنیم
model.eval()  # مدل را در حالت ارزیابی قرار می‌دهیم

# پیش‌پردازش تصویر جدید
image_path = "new_image.jpg"  # مسیر تصویر جدید
...
img_gray = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)  # تبدیل به گراسیل
